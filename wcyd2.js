...
[rewrite_local]
#文创阅读
http://gqbakmhg.bar/hfTask/startRead url script-request-header https://raw.githubusercontent.com/age174/-/main/wcyd.js

#loon
http://gqbakmhg.bar/hfTask/startRead script-path=https://raw.githubusercontent.com/age174/-/main/wcyd.js, requires-header=true, timeout=10, tag=文创阅读

#surge
文创阅读 = type=http-request,pattern=http://gqbakmhg.bar/hfTask/startRead,requires-header=1,max-size=0,script-path=https://raw.githubusercontent.com/age174/-/main/wcyd.js,script-update-interval=0

[MITM]
hostname = gqbakmhg.bar
...
let url = {
        url : 'http://gqbakmhg.bar/hfTask/startRead',
...
let url = {
        url : "http://gqbakmhg.bar/hfTask/read",
        headers : JSON.parse(wcydhd),
        body : '',
...
function wcydyd(timeout = 0) {
  return new Promise((resolve) => {
let url = {
        url : "http://gqbakmhg.bar/hfTask/getUser",
        headers : JSON.parse(wcydhd),
        body :'',
}
      $.post(url, async (err, resp, data) => {
...
let url = {
        url : "http://gqbakmhg.bar/hfTask/cash",
        headers : JSON.parse(wcydhd),
